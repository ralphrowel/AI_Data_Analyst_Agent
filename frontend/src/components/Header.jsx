    ...
    <header className="flex items-center gap-4 px-4 py-2 border-b border-surface-200 dark:border-gray-700 bg-white dark:bg-gray-900 shrink-0">
      ...
      <div className="flex items-center gap-3 shrink-0">
        <label className="relative inline-flex items-center gap-1.5 cursor-pointer">
          ...
          <div className="w-8 h-4 bg-surface-300 dark:bg-gray-600 rounded-full peer-checked:bg-accent after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-3 after:w-3 after:transition-all peer-checked:after:translate-x-4" />
          {darkMode ? (
