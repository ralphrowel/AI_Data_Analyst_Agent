  ...
  return (
    <header className="flex items-center gap-4 px-4 py-2 border-b border-surface-200 dark:border-gray-700 bg-white dark:bg-gray-900 shrink-0">
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        {userQuota && (
          <div
            className="flex items-center gap-2 px-2.5 py-1 rounded-lg bg-surface-100 dark:bg-gray-800 border border-surface-200 dark:border-gray-700 select-none shadow-xs"
        ...
        <button
          ...
          className="flex items-center gap-2 px-2 py-1 rounded-lg hover:bg-surface-100 dark:hover:bg-gray-800 transition-colors cursor-pointer border border-surface-200 dark:border-gray-700 shadow-xs select-none"
