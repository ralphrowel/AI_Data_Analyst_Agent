  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 w-full max-w-sm mx-4">
        ...
        <h3 className="text-lg font-semibold text-surface-800 dark:text-gray-100 text-center">Clear Chat?</h3>
        <p className="text-sm text-surface-500 dark:text-gray-400 text-center mt-2 leading-relaxed">
          This will remove all messages, charts, and reset token usage. This cannot be undone.
        </p>
        <div className="flex gap-3 mt-6">
          <button
            onClick={onCancel}
            className="flex-1 px-4 py-2 text-sm font-medium text-surface-600 dark:text-gray-300 bg-surface-100 dark:bg-gray-700 hover:bg-surface-200 dark:hover:bg-gray-600 rounded-lg transition-colors cursor-pointer"
          >
            Cancel
          </button>
          <button
